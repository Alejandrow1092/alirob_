                ...
                <table  id="tabla1">
                    <tbody>
                        <tr>
                            ...
                            <td id="imagen"><img src="../assets/img/escudo_escom.png" alt="ESCOM" width="100px" height="auto"/></td>
                            <td id="nombre">Andrew Adamatzky</td>
                            <td id="imagen"><img src="../assets/img/uwe.png" alt="uwe" width="200px" height="auto"/></td>
                        </tr>
                        <tr>
                            <td id="nombre">Luz Noe Oliva Moreno</td>
                            <td id="imagen"><img src="../assets/img/upiih.jpg" alt="ESCOM" width="100px" height="auto"/></td>
                            <td id="nombre">Ivan Zelinka</td>
                            <td id="imagen"><img src="../assets/img/vsb.png" alt="uwe" width="200px" height="auto"/></td>
                        </tr>
                        <tr>
